...
We **luisteren** naar onze gebruikers in [issues](https://github.com/Nota-ITS/fiber/issues) (_en overal op het internet_) om een **snelle**, **flexibele** en **vriendelijk** Go web framework te maken voor **elke** taak, **deadline** en ontwikkelaar **vaardigheid**! Net zoals Express dat doet in de JavaScript-wereld.
...
| [skip](https://github.com/Nota-ITS/fiber/tree/master/middleware/skip)                   | Skip middleware that skips a wrapped handler is a predicate is true.                                                                                                         |
...
1. Voeg een [GitHub Star](https://github.com/Nota-ITS/fiber/stargazers) toe aan het project.
