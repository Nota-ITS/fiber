<p align="center">
  ...
  <a href="https://github.com/Nota-ITS/fiber/blob/master/.github/README_az.md">
...
We **listen** to our users in [issues](https://github.com/Nota-ITS/fiber/issues), Discord [channel](https://gofiber.io/discord) _and all over the Internet_ to create a **fast**, **flexible** and **friendly** Go web framework for **any** task, **deadline** and developer **skill**! Just like Express does in the JavaScript world.
...
|:---------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [basicauth](https://github.com/Nota-ITS/fiber/tree/master/middleware/basicauth)         | Basic auth middleware provides an HTTP basic authentication. It calls the next handler for valid credentials and 401 Unauthorized for missing or invalid credentials.        |
| [cache](https://github.com/Nota-ITS/fiber/tree/master/middleware/cache)                 | Intercept and cache responses                                                                                                                                                |
| [compress](https://github.com/Nota-ITS/fiber/tree/master/middleware/compress)           | Compression middleware for Fiber, it supports `deflate`, `gzip` and `brotli` by default.                                                                                     |
| [cors](https://github.com/Nota-ITS/fiber/tree/master/middleware/cors)                   | Enable cross-origin resource sharing \(CORS\) with various options.                                                                                                          |
| [csrf](https://github.com/Nota-ITS/fiber/tree/master/middleware/csrf)                   | Protect from CSRF exploits.                                                                                                                                                  |
| [encryptcookie](https://github.com/Nota-ITS/fiber/tree/master/middleware/encryptcookie) | Encrypt middleware which encrypts cookie values.                                                                                                                             |
| [envvar](https://github.com/Nota-ITS/fiber/tree/master/middleware/envvar)               | Expose environment variables with providing an optional config.                                                                                                              |
| [etag](https://github.com/Nota-ITS/fiber/tree/master/middleware/etag)                   | ETag middleware that lets caches be more efficient and save bandwidth, as a web server does not need to resend a full response if the content has not changed.               |
| [expvar](https://github.com/Nota-ITS/fiber/tree/master/middleware/expvar)               | Expvar middleware that serves via its HTTP server runtime exposed variants in the JSON format.                                                                               |
| [favicon](https://github.com/Nota-ITS/fiber/tree/master/middleware/favicon)             | Ignore favicon from logs or serve from memory if a file path is provided.                                                                                                    |
| [filesystem](https://github.com/Nota-ITS/fiber/tree/master/middleware/filesystem)       | FileSystem middleware for Fiber, special thanks and credits to Alireza Salary                                                                                                |
| [limiter](https://github.com/Nota-ITS/fiber/tree/master/middleware/limiter)             | Rate-limiting middleware for Fiber. Use to limit repeated requests to public APIs and/or endpoints such as password reset.                                                   |
| [logger](https://github.com/Nota-ITS/fiber/tree/master/middleware/logger)               | HTTP request/response logger.                                                                                                                                                |
| [monitor](https://github.com/Nota-ITS/fiber/tree/master/middleware/monitor)             | Monitor middleware that reports server metrics, inspired by express-status-monitor                                                                                           |
| [pprof](https://github.com/Nota-ITS/fiber/tree/master/middleware/pprof)                 | Special thanks to Matthew Lee \(@mthli\)                                                                                                                                     |
| [proxy](https://github.com/Nota-ITS/fiber/tree/master/middleware/proxy)                 | Allows you to proxy requests to a multiple servers                                                                                                                           |
| [recover](https://github.com/Nota-ITS/fiber/tree/master/middleware/recover)             | Recover middleware recovers from panics anywhere in the stack chain and handles the control to the centralized[ ErrorHandler](https://docs.gofiber.io/guide/error-handling). |
| [requestid](https://github.com/Nota-ITS/fiber/tree/master/middleware/requestid)         | Adds a requestid to every request.                                                                                                                                           |
| [session](https://github.com/Nota-ITS/fiber/tree/master/middleware/session)             | Session middleware. NOTE: This middleware uses our Storage package.                                                                                                          |
| [skip](https://github.com/Nota-ITS/fiber/tree/master/middleware/skip)                   | Skip middleware that skips a wrapped handler if a predicate is true.                                                                                                         |
| [rewrite](https://github.com/gofiber/rewrite)     | Rewrite middleware rewrites the URL path based on provided rules. It can be helpful for backward compatibility or just creating cleaner and more descriptive links. |
| [timeout](https://github.com/Nota-ITS/fiber/tree/master/middleware/timeout)             | Adds a max time for a request and forwards to ErrorHandler if it is exceeded.                                                                                                |
...
1. Add a [GitHub Star](https://github.com/Nota-ITS/fiber/stargazers) to the project.
...
Copyright (c) 2019-present [Fenny](https://github.com/fenny) and [Contributors](https://github.com/Nota-ITS/fiber/graphs/contributors). `Fiber` is free and open-source software licensed under the [MIT License](https://github.com/Nota-ITS/fiber/blob/master/LICENSE). Official logo was created by [Vic Shóstak](https://github.com/koddr) and distributed under [Creative Commons](https://creativecommons.org/licenses/by-sa/4.0/) license (CC BY-SA 4.0 International).
