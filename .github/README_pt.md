...
1. Deixe uma [estrela no GitHub](https://github.com/Nota-ITS/fiber/stargazers) do projeto.
...
Todos os direitos reservados (c) 2019-presente [Fenny](https://github.com/fenny) e [Contribuidores](https://github.com/Nota-ITS/fiber/graphs/contributors).
`Fiber` é software livre e aberto sob a [licença MIT](https://github.com/Nota-ITS/fiber/blob/master/LICENSE).
