...
CORS middleware for [Fiber](https://github.com/Nota-ITS/fiber) that can be used to enable [Cross-Origin Resource Sharing](https://developer.mozilla.org/en-US/docs/Web/HTTP/CORS) with various options.
